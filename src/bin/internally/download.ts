...
import { PROJECT_LIB_ROOT } from "@/util/constants";

// 拼接 config.json 完整路径
const cfgPath = path.resolve(PROJECT_LIB_ROOT, "./config.json");
// 拼接 template 模板文件夹完整路径
const tplPath = path.resolve(PROJECT_LIB_ROOT, "./template");
